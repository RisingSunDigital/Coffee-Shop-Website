# Jacoby's Coffee — website + online ordering
...
1. Create a new repository on GitHub (e.g. `jacobys-coffee`). Leave it empty —
...
2. On your computer, in this folder, run:
   ...
   git branch -M main
   git remote add origin https://github.com/YOUR-USERNAME/jacobys-coffee.git
...
3. Choose **GitHub**, authorize Netlify, and pick your `jacobys-coffee` repo.
...
use something like `jacobyscoffee.com`:
